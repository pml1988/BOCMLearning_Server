                ...
                <form method="post" class="form-horizontal" >
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="input" name="name" class="input-xlarge" type="text" value="{{Input::old('name',$group->name)}}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="num" disabled="disabled" class="input-xlarge" type="text" value="{{Input::old('num',$group->num)}}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea name="detail">{{$group->detail}}</textarea>
                            ...
                            <div class="controls">
                                <ul class="thumbnails" id="video_list">
                                    <li id="file_list">
                                        ...
                                        <input type="hidden" name="icon_url" value="{{$group->icon_url}}">
                                    </li>
                                </ul>
                                <a class="btn btn-danger" id="add_file">修改图标</a>
