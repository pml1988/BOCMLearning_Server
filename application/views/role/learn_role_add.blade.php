        ...
        <div class="data-container">
            <header>
                ...
                <ul class="data-header-actions">
                    <li>
                        <a class="btn btn-inverse" href="{{URL::to('role/learn_role_list')}}">返回</a>
                    </li>
                </ul>
            </header>
            <section>
                <form method="post" name="myform" id="form">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <p class="help-block">
                                注:添加的管理员权限根据学习管理员本身的机构代码自动区别学习管理员地区,省行学习管理员可以添加本条线员工和辖内机构的学习管理员,南京地区和分支行学习管理员只能添加所属行号下的员工
                            </p>
                        </div>
