        ...
        <div class="data-container">
            <header>
                ...
                <ul class="data-header-actions">
                    <li>
                        <a class="btn btn-inverse" href="{{URL::to('role/product_role_list')}}">返回</a>
                    </li>
                </ul>
            </header>
            <section>
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls row-fluid">
                                ...
                                <div class="row span2">
                                    <input onclick="unselectall()" name="product_type_id[]" {{in_array($type->id,explode(',',$role->describe)) ? 'checked="checked"' : ''}} type="checkbox" value="{{$type->id}}">
                                    {{$type->name}}
                                    </div>
                                @endforeach
                                <div class="row span2">
