        ...
        <div class="data-container">
            ...
            <fieldset>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="input" name="title" class="input-xlarge" type="text" value="{{Input::old('title',$task->title)}}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="checkbox">
                            <input id="optionsCheckbox" name="status" {{Input::old('status',$task->status) != 1 ? '' : 'checked="checked"'}} type="checkbox" value="1">
                            立即发布任务
                        </label>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="Wdate" id="d1" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'d2\')}'})" type="text" name="start_at" value="{{Input::old('start_at',$task->start_at)}}">
                        至
                        <input class="Wdate" id="d2" onclick="WdatePicker({minDate:'#F{$dp.$D(\'d1\')}'})" type="text" name="end_at" value="{{Input::old('end_at',$task->end_at)}}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        任务结束<input name="notify_before"  type="number" value="{{Input::old('notify_before',$task->notify_before)}}" style="width: 50px">天前进行提醒
                        <label class="checkbox">
                            <input name="sms_notify" {{Input::old('sms_notify',$task->sms_notify) != 1 ? '' : 'checked="checked"'}} type="checkbox" value="1">
                            短信提醒
                        </label>
                        <label class="checkbox">
                        <input name="push_notify" {{Input::old('push_notify',$task->push_notify) != 1 ? '' : 'checked="checked"'}} type="checkbox" value="1">
                            客户端推送提醒
                        </label>
                                    ...
                                    <div class="accordion-inner">
                                        ...
                                        <div class="well row">
                                            ...
                                            <div class="row-fluid span10">
                                                ...
                                                <div class="span3">
                                                    <input type="checkbox" {{in_array($product->id,unserialize($task->products)) ? 'checked="checked"' : ''}}  name="product_id[]" value="{{$product->id}}"> {{$product->product_name}}
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
