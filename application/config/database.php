...
return array(
	...
	*/
	...
	'default' => isset($_SERVER['LARAVEL_ENV']) ? $_SERVER['LARAVEL_ENV'] : 'production',
	...
	*/
	...
	'redis' => array(
		...
		'default' => array(
			'host'     => '127.0.0.1',
			'port'     => 6379,
			'database' => (isset($_SERVER['LARAVEL_ENV']) AND $_SERVER['LARAVEL_ENV'] == 'development') ? 1 : 0,
		),
