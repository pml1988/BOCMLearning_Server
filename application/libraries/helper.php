...
class Helper {
    ...
    public static function ellipsize_cn($str, $max_length, $position = 1,$codepage = 'UTF-8', $ellipsis = '&hellip;')
    {
        // Strip tags
    ...
    public static function html_sub_string($content,$maxlen=300,$charset="UTF8")
    {
    ...
    public static function html_cut($body, $size, $format = NULL)
    {
    ...
    public static function add_site_uri($url)
    {
        if($url[0] == '/')
            return URL::base().$url;
        else
