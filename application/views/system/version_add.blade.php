                ...
                <form method="post">
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea id="content" name="content" rows="4">{{Input::old('content')}}</textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="checkbox">
                                    <input id="optionsCheckbox" name="is_force" {{Input::old('is_force') != 1 ? '' : 'checked="checked"'}} type="checkbox" value="1">
                                    强制升级
                                </label>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="version" name="version" class="input-xlarge" type="text" value="{{Input::old('version')}}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="version_code" name="version_code" class="input-xlarge" type="text" value="{{Input::old('version_code')}}">
